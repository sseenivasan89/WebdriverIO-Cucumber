...
const jsonTmpDirectory = `test/reports/json/temp/`;
const reportDir = `test/reports/html/`;
...
if (argv.parallel === 'true') {
    ...
    tmpSpecDirectory = `${sourceSpecDirectory}/temp`;
...
exports.config = {
    ...
    suites: {
        ...
        get: [
            './test/features/getcall.feature',
        ],
        post: [
            './test/features/postcall.feature',
        ]
    },
    // Patterns to exclude.
    exclude: [
    ...
    cucumberOpts: {   
        ...
        require: ['./test/stepDefinitions/*.js', './test/utils/report.js'],        // <string[]> (file/dir) require files before executing features
